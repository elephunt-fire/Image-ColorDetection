...
root = Tk()
root.title('Color Image Detection')
...
def showImage () :
    ...
    if filename:
        ...
        # Resize image to fit into the box (310x270) using the updated resampling method
        img = img.resize((310, 270), Image.Resampling.LANCZOS)

        # Convert image to PhotoImage format for Tkinter
        img = ImageTk.PhotoImage(img)

        label.configure(image=img, width=310, height=270)
        label.image = img
...
hex1 = Label(colors, text='#b8255f' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex1.place(x=60 ,y= 15)
hex2 = Label(colors, text='#db4035' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex2.place(x=60 ,y= 65)
hex3 = Label(colors, text='#ff9933' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex3.place(x=60 ,y= 115)
hex4 = Label(colors, text='#fad000' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex4.place(x=60 ,y= 165)
hex5 = Label(colors, text='#afb83b' , fg ='#000' , font='arial 15 bold' , bg= 'white')
...
hex6 = Label(colors2, text='#7ecc49' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex6.place(x=60 ,y= 15)
hex7 = Label(colors2, text='#299438' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex7.place(x=60 ,y= 65)
hex8 = Label(colors2, text='#6accbc' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex8.place(x=60 ,y= 115)
hex9 = Label(colors2, text='#158fad' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex9.place(x=60 ,y= 165)
hex10 = Label(colors2, text='#14aaf5' , fg ='#000' , font='arial 15 bold' , bg= 'white')
hex10.place(x=60 ,y= 215)

#selecting image
selectimage = Frame(frame,width=340 ,height = 350 , bg='#d6dee5' )
selectimage.place(x=350 , y= 10)
f= Frame(selectimage, bd= 3, bg = 'black' , width = 320 , height= 330 , relief= GROOVE)
f.place(x=10 , y= 10)

label = Label(f, bg= 'black')
label.place(x=0 , y =0)
